...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "bg-transparent border-b text-muted-foreground inline-flex h-9 w-fit items-center justify-center ",
        className
      )}
      {...props}
    />
